...
class App extends Component {
  ...
  handleSubmitNewMovie(e) {
    ...
    //https://ancient-island-40287.herokuapp.com/movies
    axios.get(`https://ancient-island-40287.herokuapp.com/movies?movie_name=${name}`)
    .then((response) => {
  ...
  handleSubmitScore(e) {
    ...
    .then((response) => {
      if(response.data.movie === null) {
       ...
       axios.patch(`https://ancient-island-40287.herokuapp.com/movies?movie_name=${name}&score=${score}`)
       .then((response) => {
  ...
  handleSearchMovieSubmit(e){
    ...
    axios.get(`https://ancient-island-40287.herokuapp.com/movies/search?genre=${searchGenre}&from=${fromYear}&to=${toYear}`)
    .then((response) => {
